...
def trainW2V(corpus,epochs = 20, num_feature = 100, sg = 1, \
    ...
    w2v = word2vec.Word2Vec(workers = num_workers,sample = sample, min_count = min_word_count, window = context)
...
def initweightlist(w2v, idx2word, word2idx):
    ...
    for i in range(len(idx2word)):
        init_weight_wv.append(w2v.wv[idx2word[i]])
