...
'''
from seqlib import *
from tensorflow.python.keras.layers import LSTM, Dense, Embedding, Dropout, Activation
...
class Lstm_Net(object):
    ...
    def train(self,modelname):
        result = self.model.fit(self.train_X, self.Y_train, batch_size = self.batch_size, epochs = 2, validation_data = (self.test_X, self.Y_test))
